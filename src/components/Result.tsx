...
function Result({ data, onReset, isError }: ResultProps) {
          ...
          <ContentWrap>
            ...
            <DescWrap>
              ...
              <DescContent>
                ...
                <Score color={scoreColor(genderScore)}>
                  {genderScore}
              ...
              <DescContent>
                ...
                <Score color={scoreColor(ageScore)}>
                  {ageScore}
                  <Percentage>%</Percentage>
                </Score>
              </DescContent>
              <DescContent>
                ...
                <Score color={scoreColor(emotionScore)}>
                  {emotionScore}
                  <Percentage>%</Percentage>
                </Score>
              </DescContent>
              <DescContent>
                ...
                <Score color={scoreColor(celebrityScore)}>
                  {celebrityScore}
                  <Percentage>%</Percentage>
                </Score>
              </DescContent>
